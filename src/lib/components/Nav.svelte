...
<div class="fixed top-0 w-full z-50 px-6 transition-all duration-500 {scrolled ? 'pt-4' : 'pt-8'} pointer-events-none">
	<nav class="max-w-4xl mx-auto liquid-panel flex items-center justify-between px-6 py-3 pointer-events-auto shadow-2xl relative z-20">
	...
	{#if mobileMenuOpen}
		<div class="absolute top-full left-6 right-6 mt-4 liquid-panel p-6 flex flex-col gap-6 md:hidden pointer-events-auto">
